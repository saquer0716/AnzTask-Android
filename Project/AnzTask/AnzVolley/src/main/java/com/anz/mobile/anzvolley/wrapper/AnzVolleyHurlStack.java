...
public class AnzVolleyHurlStack implements HttpStack {
     ...
     */
    public AnzVolleyHurlStack(UrlRewriter urlRewriter) {
     ...
     */
    public AnzVolleyHurlStack(UrlRewriter urlRewriter, SSLSocketFactory sslSocketFactory) {
